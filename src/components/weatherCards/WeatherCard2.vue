<template>
  <BaseSpinner v-if="!temperature || !icon"></BaseSpinner>
  <section v-else class="card">
    <div>
      <div class="grid-column">
        ...
        <div class="grid-row">
          <span>{{ Math.round(temperature) }}{{degrees}}</span>
          <h3>
            {{ Math.round(minTemperature[0]) }}{{ degree }} {{ slash }}
            {{ Math.round(maxTemperature[0]) }}{{degree}}
          </h3>
        </div>
      </div>
    </div>
    <div>
      <div class="grid-column-3 with-border">
        <div class="grid-row">
          ...
          <p>
            {{ Math.round(minTemperature[1]) }}{{degree}}{{slash}} {{
        ...
        <div class="grid-row">
          ...
          <p>
            {{ Math.round(minTemperature[2]) }}{{degree}}{{slash}} {{
        ...
        <div class="grid-row">
          ...
          <p>
            {{ Math.round(minTemperature[3]) }}{{degree}}{{slash}} {{
    ...
    <div>
      <div class="grid-column-3 with-border">
        <div class="grid-row">
          ...
          <p>
            {{ Math.round(minTemperature[4]) }}{{degree}}{{slash}} {{
        ...
        <div class="grid-row">
          ...
          <p>
            {{ Math.round(minTemperature[5]) }}{{degree}}{{slash}} {{
        ...
        <div class="grid-row">
          ...
          <p>
            {{ Math.round(minTemperature[6]) }}{{degree}}{{slash}} {{
...
import { useWeather } from "../../utils/weather/fetchWeather2";
...
.card {
  ...
  background: url("../../assets/weather/background.png");
